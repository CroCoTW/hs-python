...
if __name__ == "__main__":
	...
	end_turn = Move(type = MoveType.EndThisTurn)
	g.do_move(end_turn)

	g.do_move(end_turn)


	g.player[1].cards[Tag.Hand] = [Card(1, cp.find("EX1_598")), Card(1, cp.find("EX1_598")), Card(1, cp.find("EX1_010"))]
	...
	g.do_move(moves[0])
	g.player[2].cards[Tag.Hand] = [Card(2, cp.find("EX1_tk28")), Card(2, cp.find("CS2_119")), Card(2, cp.find("EX1_010"))]
